...
//lets show selected columns on the top
                                                    ...
                                                    <?php if (!empty($f['title'])): ?>
                                                        <li class="wpbe_options_li <?php if (isset($f['move'])): ?>unsortable<?php endif; ?>" <?php if ($counter > 0): ?>style="display: none;"<?php endif; ?>>
                                                            ...
                                                            <div class="col-lg-6">
                                                                ...
                                                                <?php if (!isset($f['move'])): ?>
                                                                    <a href="#" class="help_tip wpbe_drag_and_drope2" title="<?php esc_html_e('drag and drop', 'bulk-editor') ?><?php echo ($show_notes ? ' - ' . esc_html('premium version', 'bulk-editor') : '') ?>"><img src="<?php echo WPBE_ASSETS_LINK ?>images/move.png" alt="<?php esc_html_e('move', 'bulk-editor') ?>" /></a>
                                                                <?php endif; ?>
                                                                ...
                                                                <input type="checkbox" value="0" disabled="" <?php checked($f['site_editor_visibility']) ?> class="site_editor_visibility" data-key="<?php echo esc_html($key) ?>" id="site_editor_visibility_<?php echo $key ?>" />&nbsp;<label><?php esc_html_e('visible for the site editor', 'bulk-editor') ?>
                                ...
                                <td class="general-settings-td">
                                    <h4><?php esc_html_e('General settings', 'bulk-editor') ?> - <a href="https://bulk-editor.pro/document/settings/" target="_blank" class="button button-primary wpbe-info-btn"><span class="icon-book"></span>&nbsp;<?php esc_html_e('Documentation', 'bulk-editor') ?></a></h4>
                                                ...
                                                <div class="wpbe-control">
                                                    ...
                                                    switch ($o['type']) {
                                                        ...
                                                        case 'number':
                                                            ...
                                                            ?>
                                                            <input type="number" <?php if ($k === 'per_page'): ?>readonly=""<?php endif; ?> name="wpbe_options[options][<?php echo $k ?>]" value="<?php echo $o['value'] ?>" />
