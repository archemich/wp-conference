<?php
/*
  Plugin Name: WPBE - Posts Bulk Editor Professional
  Plugin URI: https://bulk-editor.pro/
  Description: WPBE - Posts Bulk Editor Professional. Tools for managing and bulk edit posts, pages and all custom types data in the reliable and flexible way! Be professionals with managing data of your site!
            ...
            if (isset($opt['options']['show_admin_bar_menu_btn']) AND intval($opt['options']['show_admin_bar_menu_btn']) === 1) {
                $args = array(
                    ...
                    'meta' => array(
                        ...
                        'title' => 'WPBE - Posts Bulk Editor Professional'
                    )
                );
...
//***
    ...
    public function plugin_action_links($links) {
        ...
        $wpbe_links = array(
            ...
            '<a target="_blank" href="' . esc_url('https://bulk-editor.pro/') . '"><span class="icon-book"></span>&nbsp;' . esc_html('Documentation', 'bulk-editor') . '</a>'
        );
