...
<div class="wpbe_delete_wraper wpbe-float-right">
    ...
    <input type="checkbox" disabled="" id="wpbe_bulk_delete_posts_btn_fuse" value='1'>
    ...
    <a href="javascript: void(0);" disabled='disabled' class="button button-primary button-large" ><?php printf(esc_html('Delete [%s]!', 'bulk-editor'), $WPBE->settings->current_post_type) ?></a>
