...
global $WPBE;
?>
<h4><?php esc_html_e('History', 'bulk-editor') ?> - <a href="https://bulk-editor.pro/document/history/" target="_blank" class="button button-primary wpbe-info-btn"><span class="icon-book"></span>&nbsp;<?php esc_html_e('Documentation', 'bulk-editor') ?></a></h4>
<small><i><?php esc_html_e('Works for edit-operations and not work with delete-operations!', 'bulk-editor') ?></i></small><br />

<?php if ($WPBE->show_notes) : ?>
<span class="wpbe_set_attention"><?php esc_html_e('In FREE version of the plugin it is possible to roll back 2 last operations.', 'bulk-editor') ?></span><br />
<?php endif; ?>
...
<div class="col-lg-6 wpbe-text-align-right">
    <a href="javascript: wpbe_history_clear();void(0);" class="page-title-action"><?php esc_html_e('Clear the History', 'bulk-editor') ?></a>
</div>
<div class="clear"></div>
<div class="col-lg-12 wpbe_history_pagination_cont">
    ...
    <div class="col-lg-12 wpbe_history_filters">
        ...
        <div class="col-lg-2" >
            ...
            $opt_auth[-1] = esc_html('by Author', 'bulk-editor');
