...
final class WPBE_HISTORY extends WPBE_EXT {
    ...
    public function __construct() {
        ...
        //tabs
        $this->add_tab($this->slug, 'panel', esc_html('History', 'bulk-editor'));
  ...
  KEY `user_id` (`user_id`)
        ...
        if ($wpdb->query($sql1) === false) {
            ...
            <div class="error notice">
                <p class="description"><?php esc_html_e("WPBE cannot create the database table! Make sure that your mysql user has the CREATE privilege! Do it manually using your host panel phpmyadmin!", 'bulk-editor') ?></p>
