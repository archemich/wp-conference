...
global $WPBE;
?>
<h4><?php esc_html_e('Meta Fields', 'bulk-editor') ?> - <a href="https://bulk-editor.pro/document/wordpress-posts-meta-fields/" target="_blank" class="button button-primary wpbe-info-btn"><span class="icon-book"></span>&nbsp;<?php esc_html_e('Documentation', 'bulk-editor') ?></a></h4>
